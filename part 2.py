...
def main():
    ...
    while True:
        ...
        choice = input("Enter your choice (1-6): ")  # Prompt the user to enter a choice from the menu
        ...
        if choice == '1':
            ...
            print("Exiting the application. Goodbye!")  # Print a message and exit the application if '6' is chosen
            break  # Exit the loop and end the program
        else:
            print("Invalid choice. Please enter a number between 1 and 6.")  # Print an error message for invalid choices
